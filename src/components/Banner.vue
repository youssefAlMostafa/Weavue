...
<template>
   <section
      class="relative rounded-[36px] max-w-[1800px] px-12 mx-auto w-[96%] pb-[48px]
             transition-all duration-1000 bg-gradient-to-br shadow-2xl overflow-hidden
             max-md:w-[90%] max-md:px-8"
      ...
      <div class="flex mt-[24px] justify-between px-[64px] relative z-10
         ...
         <div class="relative max-md:hidden">
            <img :src="BannerImage" class="w-[36vw] max-w-[550px] h-fit relative z-10
                                          animate-float
      ...
      <dialog :class="{ 'modal modal-open': showResetModal }" class="modal">
         <div class="modal-box">
            ...
            <p class="py-4">This will clear all saved cities and your current location. Are you sure you want to continue?</p>
